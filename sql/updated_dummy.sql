...
INSERT INTO tbl_option (product_id, option_quantity, option_check)VALUES
                                                        (1, 50, 'N'),   -- '토마토 쥬스 소품' 상품 (옵션 없음)
                                                        (2, 200, 'N'),  -- '콜라' 상품에 대한 옵션 없음
                                                        (3, 150, 'N'),  -- '오렌지 주스' 상품에 대한 옵션 없음
                                                        (4, 75, 'N'),   -- '초코 케이크' 상품에 대한 옵션 없음
                                                        (5, 45, 'N'),   -- '냄비 세트' 상품에 대한 옵션 없음
                                                        (6, 150, 'N'),  -- '비누 세트' 상품 (옵션 없음)
                                                        (7, 100, 'N'),  -- '베개' 상품 (옵션 없음)
                                                        (8, 200, 'N');  -- '여름 티셔츠' 상품 (옵션 없음)
...
INSERT INTO tbl_option (option_desc, add_price, product_id, option_quantity, option_check)VALUES
                                                                                ('제로 칼로리', 300, 2, 150, 'Y'),    -- '콜라' 상품에 대한 옵션
                                                                                ('사이다', 500, 2, 150, 'Y'),        -- '콜라' 상품에 대한 옵션
                                                                                ('1.25리터', 1000, 2, 150, 'Y'),    -- '콜라' 상품에 대한 옵션
                                                                                ('용량 선택', 500, 3, 100,'Y'),         -- '오렌지 주스' 상품에 대한 옵션
                                                                                ('홀케이크로 변경 ', 20000, 4, 50,'Y'), -- '초코 케이크' 상품에 대한 옵션
                                                                                ('추가 사은품', 2000, 5, 30,'Y');  -- '냄비 세트' 상품에 대한 옵션
