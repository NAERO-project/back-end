...
INSERT INTO tbl_order_detail (product_id, count, amount,
...
INSERT INTO tbl_magazine ( magazine_title, magazine_content, magazine_photo)VALUES
    ('매거진 html 형식으로 할 것을 건의합니다', '<h1>html 형식으로 넣으면 나중에 inner HTML으로 html랜더링이 가능하다는 사실. 알고 계셧나요.</h1> <div> 아무튼 그렇다고 합니다. </div>',
